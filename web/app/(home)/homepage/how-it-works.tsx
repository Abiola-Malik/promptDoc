...
const steps = [
  {
    ...
    description:
      "Simply upload your code files or paste them directly into PromptDoc.",
  },
  {
    icon: Zap,
    title: "Prompt the AI for Style or Depth",
    description:
      "Customize the documentation style, depth, and format with natural language prompts.",
  },
  {
    icon: Download,
    title: "Review, Edit, and Export",
    description:
      "Review the generated documentation, make edits, and export in your preferred format.",
  },
];
