 ...
 * @param {string | number} end
 * @returns {string}
 */ Query.notBetween = (attribute, start, end)=>new Query("notBetween", attribute, [
        start,
        end
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.intersects = (attribute, values)=>new Query("intersects", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.notIntersects = (attribute, values)=>new Query("notIntersects", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.crosses = (attribute, values)=>new Query("crosses", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.notCrosses = (attribute, values)=>new Query("notCrosses", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.overlaps = (attribute, values)=>new Query("overlaps", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.notOverlaps = (attribute, values)=>new Query("notOverlaps", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.touches = (attribute, values)=>new Query("touches", attribute, [
        values
    ]).toString();
/**
 ...
 * @param {any[]} values
 * @returns {string}
 */ Query.notTouches = (attribute, values)=>new Query("notTouches", attribute, [
        values
    ]).toString();
/**
...
class Realtime {
    ...
    subscribe(channelsOrChannel, callback) {
        return __awaiter(this, void 0, void 0, function*() {
            const channels = Array.isArray(channelsOrChannel) ? new Set(channelsOrChannel) : new Set([
                channelsOrChannel
            ]);
 ...
 * @param {any} value
 * @returns {string}
 */ Operator.arrayInsert = (index, value)=>new Operator("arrayInsert", [
        index,
        value
    ]).toString();
/**
 ...
 * @param {any} value
 * @returns {string}
 */ Operator.arrayRemove = (value)=>new Operator("arrayRemove", [
        value
    ]).toString();
/**
 ...
 * @param {any} value
 * @returns {string}
 */ Operator.stringConcat = (value)=>new Operator("stringConcat", [
        value
    ]).toString();
/**
 ...
 * @returns {string}
 */ Operator.stringReplace = (search, replace)=>new Operator("stringReplace", [
        search,
        replace
    ]).toString();
/**
 ...
 * @param {number} days
 * @returns {string}
 */ Operator.dateAddDays = (days)=>new Operator("dateAddDays", [
        days
    ]).toString();
/**
 ...
 * @param {number} days
 * @returns {string}
 */ Operator.dateSubDays = (days)=>new Operator("dateSubDays", [
        days
    ]).toString();
/**
...
//# sourceMappingURL=node_modules_cb3c1fbe._.js.map